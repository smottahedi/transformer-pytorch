...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, embed_dim, num_hiddens, seq_len,
        ...
        self.addnorm_1 = AddNorm(seq_len, num_hiddens, dropout)
        self.attention_2 = MultiheadAttention(embed_dim, num_hiddens, num_heads,
                                              DotProductAttention(dropout))
        self.addnorm_2 = AddNorm(seq_len, num_hiddens, dropout)
        self.ffn = PositionWiseFFN(num_hiddens, ffn_num_hiddens, num_hiddens)
        self.addnorm_3 = AddNorm(seq_len, num_hiddens, dropout)
